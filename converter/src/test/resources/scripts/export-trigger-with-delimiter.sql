...
CREATE TABLE `sample` (
  ...
  KEY `FK_USER` (`USER_FK`),
  CONSTRAINT `FK_USER` FOREIGN KEY (`USER_FK`) REFERENCES `user` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='A sample table.';
...
INSERT INTO `sample` VALUES (3,1,'Hello World','2015-03-29 17:11:04',10001);
...
CREATE TABLE `user` (
  ...
  `NAME` text,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='A sample user table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-03-29 13:16:01
